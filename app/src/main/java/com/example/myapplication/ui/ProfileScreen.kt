...
fun ProfileScreen(postsVm: PostsViewModel, themeVm: ThemeViewModel) {
    ...
    Column(
        ...
        Text("Raque Alexy L. Paradillo", style = MaterialTheme.typography.headlineSmall)
        Text("@raparadillo", style = MaterialTheme.typography.bodyMedium)
        Text("BSIT 3-1 · Liceo de Cagayan University",
